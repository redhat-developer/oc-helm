/*
Copyright © 2021 Andrew Block <andy.block@gmail.com>
...
func newInstallAsyncCmd(commandLineOptions *options.CommandLineOption) *cobra.Command {

	action := action.NewInstallAsyncAction(commandLineOptions)

	// installCmd represents the install command
	installCmd := &cobra.Command{
		Use:   "install-async [NAME] [REPOSITORY/NAME]",
		Short: "Install chart",
		Long:  `Install chart`,
